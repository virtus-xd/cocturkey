...
function resolveParagraphStyle(entry, baseStyle) {
  ...
  const fontFace = (opts.fontFace && String(opts.fontFace).trim()) || baseStyle.fontFace || "Arial";
  const fontStyle =
...
function registerCanvasFontVariant(fontPath, face, fontStyle, fontWeight, cacheKey) {
